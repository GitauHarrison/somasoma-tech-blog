...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow(self):
        u1 = User(username = 'bozo', email = 'bozo@example.com')
        u2 = User(username  = 'common', email = 'common@example.com')
        db.session.add(u1)
        db.session.add(u2)
        db.session.commit()
        ...
        self.assertEqual(u1.followed.first().username, 'common')
        self.assertEqual(u2.followers.count(), 1)
        self.assertEqual(u2.followers.first().username, 'bozo')
